...
creator = ["ua7327fa99ba737731b361c429682a347","ua5b1fd053f5a6951349b912a8a7b6755"]
owner = ["ua7327fa99ba737731b361c429682a347","ua5b1fd053f5a6951349b912a8a7b6755"]
admin = ["ua7327fa99ba737731b361c429682a347","ua5b1fd053f5a6951349b912a8a7b6755"]
staff = ["ua7327fa99ba737731b361c429682a347","ua5b1fd053f5a6951349b912a8a7b6755"]
        ...
        "align": "center"
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                proses = text.split(" ")
                                urutan = text.replace(proses[0] + " ","")
                                r = requests.get("http://api.ntcorp.us/joox/search?q={}".format(str(urllib.parse.quote(urutan))))
                                data = r.text
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["MentionSticker"] == True:
                            if msg._from in owner:
                                ...
                                sendTextTemplate(msg.to,"Auto respon sticker diaktifkan")
